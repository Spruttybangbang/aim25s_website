    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_quality_score', models.IntegerField(blank=True, default=0, null=True, verbose_name='Datakvalitet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('URL_KÄLLA', models.TextField(blank=True, db_column='URL_KÄLLA', null=True, verbose_name='URL Källa')),
                ...
                ('AI_FÖRMÅGA_SEMANTISK_MODELL', models.TextField(blank=True, db_column='AI-FÖRMÅGA_SEMANTISK_MODELL', null=True, verbose_name='AI-förmåga (Semantisk Modell)')),
                ('AI_FÖRMÅGA_GAMMAL', models.TextField(blank=True, db_column='AI-FÖRMÅGA_GAMMAL', null=True, verbose_name='AI-förmåga (Gammal)')),
                ...
                ('SCB_ANSTÄLLDA', models.TextField(blank=True, db_column='SCB_ANSTÄLLDA', null=True, verbose_name='SCB Antal anställda')),
                ...
                ('SCB_OMSÄTTNING_ÅR', models.TextField(blank=True, db_column='SCB_OMSÄTTNING_ÅR', null=True, verbose_name='SCB Omsättningsår')),
                ...
                ('SCB_FÖRETAGSÅLDER', models.TextField(blank=True, db_column='SCB_FÖRETAGSÅLDER', null=True, verbose_name='SCB Företagsålder')),
            ],
            options={
                'verbose_name': 'AI-företag (Ny databas)',
                'verbose_name_plural': 'AI-företag (Ny databas)',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('column_name', models.CharField(choices=[('name', 'Företagsnamn'), ('website', 'Webbplats'), ('type', 'Typ'), ('type_new', 'Typ (ny)'), ('description', 'Beskrivning'), ('location_city', 'Stad'), ('location_greater_stockholm', 'Stor-Stockholm'), ('owner', 'Ägare'), ('logo_url', 'Logotyp URL'), ('data_quality_score', 'Datakvalitet'), ('source_url', 'Käll-URL'), ('sector_vec_1', 'Sektor Vec 1'), ('sector_vec_2', 'Sektor Vec 2'), ('organization_number', 'Organisationsnummer'), ('municipality', 'Kommun'), ('county', 'Län'), ('employee_size', 'Antal anställda'), ('legal_form', 'Juridisk form'), ('industry_1', 'Bransch 1'), ('industry_2', 'Bransch 2'), ('phone', 'Telefon'), ('email', 'E-post'), ('post_city', 'Postort'), ('sectors', 'Sektorer'), ('domains', 'Domäner'), ('ai_capabilities', 'AI-kapaciteter'), ('dimensions', 'Dimensioner')], max_length=50, unique=True, verbose_name='Kolumn')),
                ('custom_label', models.CharField(blank=True, help_text='Valfritt: Anpassat namn som visas i den publika vyn. Lämna tomt för att använda standardnamnet.', max_length=100, null=True, verbose_name='Anpassad etikett')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('company', models.ForeignKey(db_column='company_id', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='companies.company')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SCBEnrichment',
            fields=[
                ('company', models.OneToOneField(db_column='company_id', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='scb_enrichment', serialize=False, to='companies.company', verbose_name='Företag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Skapad')),
                ('resolved', models.BooleanField(default=False, verbose_name='Hanterad')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='error_reports', to='companies.company', verbose_name='Företag')),
            ],
            options={
